...
# from src.cvpose.core import imshow_keypoints, imshow_keypoints_3d
from .. import builder
...
class PoseLifter(BasePose):
    ...
    #                 radius=8,
    #                 thickness=2)
    #         img = imrescale(img, scale=vis_height / img.shape[0])

    #     img_vis = imshow_keypoints_3d(result, img, skeleton, pose_kpt_color,
    #                                   pose_limb_color, vis_height)

    #     if show:
    #         visualization.imshow(img_vis, win_name, wait_time)

    #     if out_file is not None:
    #         imwrite(img_vis, out_file)
